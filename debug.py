...
images = pose_model.generate(pil_image=image_pil, num_samples=4, num_inference_steps=50, seed=42, image=g_image_pil, strength=0.6, V_matrix=vmatrix,P_matrix=pmatrix )
